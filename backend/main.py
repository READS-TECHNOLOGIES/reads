...
#def get_recent_notifications():
  #  try:
   #     limit = request.args.get('limit', 10, #type=int)
       # notifications = #Notification.query.order_by(Notification.created_a#t.desc()).limit(limit).all()
#        
#        result = []
#        for notif in notifications:
#            recipient_count = #NotificationRecipient.query.filter_by(notification#_id=notif.id).count()
  #          result.append({
  #              'id': notif.id,
   #             'title': notif.title,
