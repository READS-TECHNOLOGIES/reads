...
const AdminModule = ({ user }) => {
    ...
    const renderAdminDashboard = () => (
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-cyan/20 to-purple-500/20 border-2 border-cyan rounded-xl p-6">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-card-muted">
                                Generate lessons, quizzes, and improve content with Google Gemini AI
                            </p>
                        </div>
                    </div>
                    <button
                        onClick={() => setActiveTab('ai-assistant')}
                        className="px-6 py-3 bg-cyan text-white rounded-lg hover:bg-primary-cyan-dark font-semibold transition-all border-2 border-cyan flex items-center"
                    >
        ...
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex border-b-2 border-cyan overflow-x-auto">
                ...
                <AdminTab 
                    ...
                    onClick={() => { setActiveTab('ai-assistant'); setQuizLesson(null); }} 
                />
                <AdminTab 
                    name="Manage Content" 
                    icon={Video} 
            ...
            <div className='py-4'>
                ...
                {activeTab === 'ai-assistant' && <AIContentAssistant onToast={showToast} />}
