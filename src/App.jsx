...
import { LayoutDashboard, BookOpen, Wallet, User, Shield, Bell } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      {/* Fixed notification bell header */}
      <div className="fixed top-0 left-0 right-0 z-40 bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-lg mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src={readsLogo} alt="$READS" className="w-7 h-7 rounded-lg" />
            <span className="font-bold text-gray-900 text-sm">$READS</span>
          </div>
          <button
